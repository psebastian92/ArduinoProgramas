...
// Define los pines RX y TX que usarás para la comunicación serial con el módulo GPS
const int RX_PIN = D4;  // Conectar TX del módulo GPS a D4 (GPIO2)
const int TX_PIN = D5;  // Conectar RX del módulo GPS a D5 (GPIO14)

// Inicializa el objeto SoftwareSerial para comunicación con el módulo GPS
