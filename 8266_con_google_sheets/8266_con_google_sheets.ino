#include "ESP8266WiFi.h"
            /*Includes ESP8266WiFi.h and WiFiClientSecure.h, just have these two libraries downloaded before*/
     /*Library file for Google Sheets, has to be used after Wi-Fi Client Secure declaration, here everything is in Trigger_WIFI.h, so using it after Trigger_WIFI.h*/ 

/**********Google Sheets Definations***********/
char column_name_in_sheets[ ][6] = {"valor1","valor2","valor3"};                        /*1. The Total no of column depends on how many value you have created in Script of Sheets;2. It has to be in order as per the rows decided in google sheets*/
String Sheets_GAS_ID = "AKfycbw5Zcd7xNQAr0NZlOxDHk0_0pogS31m2uAI58RSmQqZYyDH4qZ7IWKarf_5-eNRsjrv";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("TP-Link_3FE2","26826615");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
